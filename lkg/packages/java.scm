...
(define-public openjdk16
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri "https://github.com/openjdk/jdk/archive/refs/tags/jdk-16-ga.tar.gz")
              (file-name (string-append name "-" version ".tar.gz"))
              (sha256
               (base32
                "0ky99sbrxs6j0la6xwivh5fq04xi0ax3qkzrffs0zmrhghva84b2"))
              (modules '((guix build utils)))
              (snippet
               `(begin
                  ;; The m4 macro uses 'help' to search for builtins, which is
...
(define-public openjdk17
  (package
    ...
    (source (origin
              (method url-fetch)
              (uri "https://github.com/openjdk/jdk/archive/refs/tags/jdk-17+25.tar.gz")
              (file-name (string-append name "-" version ".tar.gz"))
              (sha256
               (base32
                "1y1wgqkklxljr1ha0vql65v90whryx2rdvxyg35zyccrhfj7q0i2"))
              (modules '((guix build utils)))
              (snippet
               `(begin
                  ;; The m4 macro uses 'help' to search for builtins, which is
